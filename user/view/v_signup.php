		...
		<!-- <div class="container">
			<div class="row"> -->
				...
				<div class="col-sm-12">
					...
					<div class="signup-form-tt col-sm-6 col-xs-12"><!--sign up form-->
						
                            <div class="col-sm-5 col-xs-10">
                            <h5>Họ</h5>
                            <input class="col-sm-12 col-xs-12" type="text" placeholder="Họ"/>
                            </div>
                            <div class="col-sm-5 col-xs-10">
                            <h5>Tên</h5>
							<input class="col-sm-12 col-xs-12" type="text" placeholder="Tên"/>
                            </div>
                            <div class="col-sm-5 col-xs-10">
                            <h5>Email</h5>
							<input class="col-sm-12 col-xs-12" type="email" placeholder="Email"/>
                            </div>
                            <div class="col-sm-5 col-xs-10">
                            <h5>Điện thoại</h5>
							<input class="col-sm-12 col-xs-12" type="text" placeholder="Điện thoại"/>
                            </div>
                            <div class="col-sm-5 col-xs-10">
                            <h5>Ngày sinh</h5>
							<input class="col-sm-12 col-xs-12" type="date" placeholder="Ngày sinh"/>
                            </div>
                            <div class="col-sm-5 col-xs-10">
                            <h5>Giới tính</h5>
							<input class="col-sm-12 col-xs-12" type="text" placeholder="Giới tính"/>
                            </div>
                            <div class="col-sm-5 col-xs-10">
                            <h5>Tỉnh/TP:</h5>
                            <input class="col-sm-12 col-xs-12" type="email" placeholder="Tỉnh/TP"/>
                            </div>
                            <div class="col-sm-5 col-xs-10">
                            <h5>Quận/Huyện</h5>
							<input class="col-sm-12 col-xs-12" type="text" placeholder="Quận/Huyện"/>
							</div>
                            <div class="col-sm-10 col-xs-10">
                            <h5>Phường/Xã</h5>
							<input class="col-sm-12 col-xs-12" type="text" placeholder="Phường/Xã"/>
							</div>
                            <div class="col-sm-10 col-xs-10">
                            <h5>Địa chỉ</h5>
                    ...
                    <div class="signup-form-ttr col-sm-6 col-xs-12">
						<div class="col-sm-10 col-xs-10">
                            <h5>Mật khẩu</h5>
							<input class="col-sm-12 col-xs-12" type="password" placeholder="Password"/>
							</div>
						<div class="col-sm-10 col-xs-10">
							...
							<input class="col-sm-12 col-xs-12" type="password" placeholder="Password"/>
								...
								<div class="col-sm-10 col-xs-10">
						<button type="submit" class=" col-sm-12 col-xs-12 btn btn-default">Signup</button>
					</div>
					</div>
					 <!--/sign up form -->
